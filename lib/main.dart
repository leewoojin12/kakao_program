...
library main;
  ...
  */
            ...
            IconButton(onPressed: () {
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AddFriend(setfriend:setfriend ,addfriendlist:addfriendlist);
                },
              );
              ...
              child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                          ...
                          itemCount: setfriend.length,
                          itemBuilder: (context,i){
                            return myprofile2(setfriend:setfriend, i:i
                            );
  ...
  class myprofile2 extends StatelessWidget {
    myprofile2({super.key, this.userImage,this.sortedNames, this.setfriend ,this.i});
    var setfriend;
    var i;
    final userImage;
    final sortedNames;
  ...
  class AddFriend extends StatefulWidget {
    AddFriend({super.key , this.friendlist  ,required this.setfriend,this.addfriendlist});

    var friendlist;
    final List<String> setfriend;
    var addfriendlist;
  ...
  class _AddFriendState extends State<AddFriend> {
    ...
    var name;
    late List<String> addfriend_get =[];
  ...
  // JSON 형식으로 데이터 전송
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          widget.addfriendlist(name);
          print(widget.addfriendlist);
          addfriend_get.add(name);
          login.friendlist.add(response.body);
        });
        print("이거는될까낭 $addfriend_get");
